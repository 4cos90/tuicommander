...
impl<T> Term<T> {
    ...
    pub fn resize_reflow<S: Dimensions>(&mut self, size: S, reflow: crate::grid::ReflowMode) {
        self.resize_reflow_with_opts(size, reflow, crate::grid::ReflowOpts::default());
    }

    pub fn resize_reflow_with_opts<S: Dimensions>(
        &mut self,
        size: S,
        reflow: crate::grid::ReflowMode,
        opts: crate::grid::ReflowOpts,
    ) {
        ...
        self.grid.resize_with_opts(primary_mode, num_lines, num_cols, opts);
