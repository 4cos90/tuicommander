...
pub fn build_router(state: Arc<AppState>, remote_auth: bool, mcp_enabled: bool) -> Router {
    ...
    let mut routes = Router::new()
        ...
        .route("/sessions/{id}/terminal/select/start", post(session::terminal_select_start))
        .route("/sessions/{id}/terminal/select/update", post(session::terminal_select_update))
        .route("/sessions/{id}/terminal/select/text", get(session::terminal_select_text))
        .route("/sessions/{id}/terminal/select/clear", post(session::terminal_select_clear))
