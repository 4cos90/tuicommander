...
describe("KeyComboCapture", () => {
	...
	it("shows current value in display button", () => {
		const { container } = render(() => <KeyComboCapture value="Cmd+K" onChange={() => {}} />);
	...
	it("shows placeholder when value is empty", () => {
		const { container } = render(() => <KeyComboCapture value="" onChange={() => {}} placeholder="Click to set" />);
		const btn = container.querySelector(".display");
	...
	it("calls onChange with captured key combo", () => {
		...
		const { container } = render(() => <KeyComboCapture value="" onChange={onChange} />);
	...
	it("exits capture mode after a key is captured", () => {
		const { container } = render(() => <KeyComboCapture value="" onChange={() => {}} />);
		fireEvent.click(container.querySelector(".display")!);
	...
	it("exits capture mode on Escape without calling onChange", () => {
		const onChange = vi.fn();
		const { container } = render(() => <KeyComboCapture value="Cmd+K" onChange={onChange} />);
		fireEvent.click(container.querySelector(".display")!);
	...
	it("shows collision warning when combo conflicts with a keybinding action", () => {
		...
		const { container } = render(() => <KeyComboCapture value="Cmd+Shift+D" onChange={() => {}} />);
