...
function getShortcutSections(): ShortcutSection[] {
  ...
  },
  {
    ...
    shortcuts: [
      ...
      ...(settingsStore.isAiChatEnabled() ? [{ action: "toggle-ai-chat" as const, keys: keyFor("toggle-ai-chat"), description: "Toggle AI Chat" }] : []),
  ...
  },
  {
    ...
    shortcuts: [
      ...
      { action: "toggle-file-browser-content-search", keys: keyFor("toggle-file-browser-content-search"), description: "Search file contents" },
